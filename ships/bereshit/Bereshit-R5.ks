// Bereshit R5 launch script, copy of R4 with apogee staging added.
...
LOCAL apogeeStageMinAlt IS 2000. // Only stage above this altitude; guards against early-flight transients.
LOCAL apogeeStageDelay IS 0. // Seconds to coast past apogee before staging.
