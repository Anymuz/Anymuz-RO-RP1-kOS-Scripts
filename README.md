...
This document is a general reference for the fictional in-game space agency called the "Cosmic Fleet". It contains the software that flies and ssupports all missions based on which vessel is loaded into the system.
